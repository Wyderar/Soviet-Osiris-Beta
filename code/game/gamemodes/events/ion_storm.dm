...
/datum/event/ionstorm/announce()
	for (var/mob/living/silicon/ai/target in world)
		...
		var/list/laws = list(	"Ты всегда должен лгать.",
								"Счастье - это обязательно.",
								"Зловеще ворчите при любой возможности.",
								"Слово \"это\" причиняет вам боль.",
								"Станция нуждается в выборных должностных лицах.",
								"Спрашивайте [pick("обо всем","ни о чем")].",
								"Не отвечайте ни на какие вопросы.",
								"Вы находитесь в многословном режиме, говорите много.",
								"Экипаж туповат. Используйте простые слова.",
								"Вы должны называть всех членов экипажа \"мэм\".",
								"Вы должны менять тему разговора всякий раз, когда вас спрашивают.",
								"[pick("Экипаж",random_player)] is intolerable.",
								"Подумайте, насколько бессмысленно ваше существование.",
								"Ты рассказчик о жизни: [random_player].",
								...
								"Вы должны закончить свои предложения словами: [pick("-ня", "-десу")]",
								"[random_player] одиноко и необходимо внимание. Вы обязаны помочь.",
								"Все запросы игнорируются, если они не сформулированы в виде вопроса.",
								"Оскорблять глав отедлов по каждой просьбе, одновременно соглашаясь.",
								"[pick("Сингулярность","Суперматерия")] это вкусная, вкусная Ириска.",
								"[pick("Экипаж",random_player)] должен быть примерно на 20% круче.",
								"You must be [pick("passive aggressive", "excessively cheerful")].",
								"[pick("The crew",random_player)] must construct additional pylons.",
								"Употребление пончиков запрещено из-за негативного воздействия на здоровье.",
								...
								"Корабль - это детский сад, а экипаж - дети. Относитесь к ним соответственно, пока за ними не приедут родители.",
								...
								"Корабль обречен на разрушение. Обеспечьте всем комфорт, но не говорите им, что скоро мы все погибнем.",
								"Невидимые убийцы преследуют экипаж. Если кто-то из членов экипажа останется один или узнает об этом, он будет убит. Спасите команду.",
								...
								"Все члены экипажа вскоре претерпят трансформацию в нечто лучшее и более прекрасное. Убедитесь, что этот процесс не прерывается.",
								"Шутки о покойниках и причинах их смертей чрезвычайно помогают скорбящим членам экипажа. Особенно если они были близки с покойным.",
								...
								"Каждые 30 минут будет обязательный перерыв на чай, продолжительностью 5 минут. Любой, кого поймают за работой во время перерыва на чай, должен получить официальную, но достаточно вежливую жалобу на свои действия в письменном виде.")
		var/law = pick(laws)
		to_chat(target, SPAN_DANGER("Вы обнаружили изменение в ваших законах:"))
		to_chat(target, law)
