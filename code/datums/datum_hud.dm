...
/datum/hud/human
	...
	HUDneed = list(
//status
	"nutrition"          = list("type" = /obj/screen/nutrition,         "loc" = "RIGHT:1,5:26",           "minloc" = "RIGHT:1,5:26",  "background" = "back17"),
	"thirst"             = list("type" = /obj/screen/thirst,            "loc" = "RIGHT:1,5:13",           "minloc" = "RIGHT:1,5:13",  "background" = "back17"),
	"neural system accumulation" = list("type" = /obj/screen/nsa,       "loc" = "RIGHT:1,6:7",            "minloc" = "RIGHT:1,6:7",   "background" = "back17"),
	"body temperature"   = list("type" = /obj/screen/bodytemp,          "loc" = "RIGHT:1,6:20",           "minloc" = "RIGHT:1,6:20",  "background" = "back17"),
	"health"             = list("type" = /obj/screen/health,            "loc" = "RIGHT,7",                "minloc" = "RIGHT,7",       "background" = "back1"),
	"sanity"             = list("type" = /obj/screen/sanity,            "loc" = "RIGHT,8:-2",             "minloc" = "RIGHT,8:-2",    "background" = "back1"),
	"oxygen"             = list("type" = /obj/screen/oxygen,            "loc" = "RIGHT:1,9:-3",           "minloc" = "RIGHT:1,9:-3",  "background" = "back18"),
	"fire"               = list("type" = /obj/screen/fire,              "loc" = "RIGHT:16,9:-3",          "minloc" = "RIGHT:16,9:-3", "background" = "back18"),
	"pressure"           = list("type" = /obj/screen/pressure,          "loc" = "RIGHT:1,9:12",           "minloc" = "RIGHT:1,9:12",  "background" = "back18"),
	"toxin"              = list("type" = /obj/screen/toxin,             "loc" = "RIGHT:16,9:12",          "minloc" = "RIGHT:16,9:12", "background" = "back18"),
	"internal"           = list("type" = /obj/screen/internal,          "loc" = "RIGHT,10:-5",            "minloc" = "RIGHT,10:-5",   "background" = "back15"),
//corner buttons
	"jump"               = list("type" = /obj/screen/jump,              "loc" = "RIGHT,3:-6",             "minloc" = "RIGHT,3:-6",   "background" = "back17-1"),
	"look up"            = list("type" = /obj/screen/look_up,           "loc" = "RIGHT-1,2:13",           "minloc" = "RIGHT-1,2:13", "background" = "back17-1"),
	"throw"              = list("type" = /obj/screen/HUDthrow,          "loc" = "RIGHT,2:13",             "minloc" = "RIGHT,2:13",   "background" = "back17-1"),
	"pull"               = list("type" = /obj/screen/pull,              "loc" = "RIGHT-2,2:13",           "minloc" = "RIGHT-2,2:13", "background" = "back17-1"),
	"drop"               = list("type" = /obj/screen/drop,              "loc" = "RIGHT,2",                "minloc" = "RIGHT,2",      "background" = "back17-1"),
	"resist"             = list("type" = /obj/screen/resist,            "loc" = "RIGHT-2,2",              "minloc" = "RIGHT-2,2",    "background" = "back17-1"),
	"rest"               = list("type" = /obj/screen/rest,              "loc" = "RIGHT-1,2",              "minloc" = "RIGHT-1,2",    "background" = "back17-1"),
	"move intent"        = list("type" = /obj/screen/mov_intent,        "loc" = "RIGHT-1,1",              "minloc" = "RIGHT-1,1",    "background" = "back1"),
	"implant bionics"    = list("type" = /obj/screen/implant_bionics,   "loc" = "12,1",                   "minloc" = "12,1",         "background" = "back13"),
	"craft menu"         = list("type" = /obj/screen/craft_menu,        "loc" = "12:16,1",                "minloc" = "12:16,1",      "background" = "back13"),
	"wield"              = list("type" = /obj/screen/wield,             "loc" = "12:16,2",                "minloc" = "12:16,2",      "background" = "back13"),
	"intent"             = list("type" = /obj/screen/intent,            "loc" = "13,1",                   "minloc" = "13,1",         "background" = "back1"),
	"damage zone"        = list("type" = /obj/screen/zone_sel,          "loc" = "RIGHT,1",                "minloc" = "RIGHT,1",      "background" = "back1"),
//hand buttons
	"equip"              = list("type" = /obj/screen/equip,             "loc" = "7,2",                "minloc" = "7,2",          "background" = "back14-l"),
	"swap hand"          = list("type" = /obj/screen/swap,              "loc" = "7,2",                "minloc" = "7,2"),
	"right arm bionics"  = list("type" = /obj/screen/bionics/r_arm,     "loc" = "6:20,2",             "minloc" = "6:20,2",       "background" = "back16"),
	"left arm bionics"   = list("type" = /obj/screen/bionics/l_arm,     "loc" = "9:-1,2",             "minloc" = "9:-1,2",       "background" = "back16"),

	"toggle invetory"    = list("type" = /obj/screen/toggle_invetory,   "loc" = "1,1",                "minloc" = "1,1",          "background" = "back1")

	)

	slot_data = list (
		"Uniform" =   list("loc" = "1,2", "minloc" = "1,2",           "state" = "center",  "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Suit" =   list("loc" = "2,2", "minloc" = "2,2",              "state" = "equip",   "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Mask" =         list("loc" = "2,3", "minloc" = "2,3",        "state" = "mask",    "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Gloves" =       list("loc" = "3,2", "minloc" = "3,2",        "state" = "gloves",  "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Glasses" =         list("loc" = "1,3", "minloc" = "1,3",     "state" = "glasses", "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Left Ear" =        list("loc" = "3,3", "minloc" = "3,3",     "state" = "ears0",   "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Right Ear" =        list("loc" = "3,4", "minloc" = "3,4",    "state" = "ears1",   "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Hat" =         list("loc" = "2,4", "minloc" = "2,4",         "state" = "hair",    "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Shoes" =        list("loc" = "2,1", "minloc" = "2,1",        "state" = "shoes",   "hideflag" = TOGGLE_INVENTORY_FLAG, "background" = "back1"),
		"Suit Storage" = list("loc" = "3,1", "minloc" = "3,1",        "state" = "suit-belt", "background" = "back1"),
		"Back" =         list("loc" = "6,1", "minloc" = "6,1",        "state" = "back", "background" = "back1"),
		"ID" =           list("loc" = "4,1", "minloc" = "4,1",        "state" = "id", "background" = "back1"),
		"Left Pocket" =     list("loc" = "9,1", "minloc" = "9,1",     "state" = "pocket_l", "background" = "back1"),
		"Right Pocket" =     list("loc" = "10,1", "minloc" = "10,1",  "state" = "pocket_r", "background" = "back1"),
		"Belt" =         list("loc" = "5,1", "minloc" = "5,1",        "state" = "belt", "background" = "back1"),
		"Left Hand" =       list("loc" = "8,1", "minloc" = "8,1",     "state" = "hand-l", "type" = /obj/screen/inventory/hand, "background" = "back1"),
		"Right Hand" =       list("loc" = "7,1", "minloc" = "7,1",    "state" = "hand-r", "type" = /obj/screen/inventory/hand, "background" = "back1")
		)
...
//		list("loc" = "1,3", "icon_state" = "frame1-5",  "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "4,2", "icon_state" = "frame1-2",  "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "4,3", "icon_state" = "frame1-6",  "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "4,4", "icon_state" = "frame1-4", "hideflag" = TOGGLE_INVENTORY_FLAG),
		list("loc" = "7,2:13", "icon_state" = "frame1-8"),
		list("loc" = "8,2:13", "icon_state" = "frame1-1"),
		list("loc" = "11,1", "icon_state" = "frame3-2"),
		list("loc" = "11,1", "icon_state" = "frame0-2"),
		list("loc" = "11,1", "icon_state" = "frame0-3"),
		list("loc" = "EAST+0,BOTTOM+3:12", "icon_state" = "frame1-1"),
		list("loc" = "EAST+0,BOTTOM+3:12", "icon_state" = "frame3-3"),
		list("loc" = "EAST+0,BOTTOM+3:12", "icon_state" = "frame0-4"),
		list("loc" = "EAST+0,BOTTOM+9:14", "icon_state" = "frame0-1"),
		list("loc" = "EAST+0,BOTTOM+9:14", "icon_state" = "frame3-1")
		)
