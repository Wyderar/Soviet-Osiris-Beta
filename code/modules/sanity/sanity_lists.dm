...
/datum/sanity/proc/pick_quote_40()
	var/static/list/sanity_quotes_40 = list(
		...
		"Это уже слишком.",
		"Вот бы дозу чего-нибудь крпекого, а то стресс совсем замучил...",  // IDK ANTON HELP PLS
		...
		"Здесь что-то не так.",
		"Чувство дежа вю зваполняет ваш разум, скрывая под собой черные мысли и желания.", // ANTON HELP PLS
...
/datum/sanity/proc/pick_quote_20()
	...
	if(!sanity_quotes_20)
		sanity_quotes_20 = list(
			...
			"Ничто никогда не будет хорошо. Ничто никогда не будет хорошо. Мир полон отчаяния.", // ANTON PLS
			...
			"Безумие застилает твои глаза - ты не модешь доверять собственным чувствам.",
