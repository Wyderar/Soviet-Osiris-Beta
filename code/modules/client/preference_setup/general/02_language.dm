...
/datum/category_item/player_setup_item/physical/languages
	name = "Languages"
	sort_order = 2
	var/list/allowed_languages
	var/list/free_languages

/datum/category_item/player_setup_item/physical/languages/load_character(var/savefile/S)
	from_file(S["language"], pref.alternate_languages)

/datum/category_item/player_setup_item/physical/languages/save_character(var/savefile/S)
	to_file(S["language"],   pref.alternate_languages)

/datum/category_item/player_setup_item/physical/languages/sanitize_character()
	if(!islist(pref.alternate_languages))
		pref.alternate_languages = list()
	sanitize_alt_languages()

/datum/category_item/player_setup_item/physical/languages/content()
	. = list()
	. += "<hr>"
	. += "<b>Языки:</b><br>"
...
/datum/category_item/player_setup_item/physical/languages/OnTopic(var/href,var/list/href_list, var/mob/user)
...
/datum/category_item/player_setup_item/physical/languages/proc/rebuild_language_cache(var/mob/user)
...
/datum/category_item/player_setup_item/physical/languages/proc/is_allowed_language(var/mob/user, var/datum/language/lang)
...
/datum/category_item/player_setup_item/physical/languages/proc/sanitize_alt_languages()
...
/datum/category_item/player_setup_item/physical/languages/proc/get_language_text()
	. = ..()
	sanitize_alt_languages()
